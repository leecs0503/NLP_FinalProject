...
class SA(nn.Module):
    def __init__(self, hidden_size, dropout=0.1):
        ...
        self.mhatt = MHAtt(hidden_size,dropout=dropout)
...
class Transformer_VQA_crossmodal(nn.Module):
    def __init__(
        self,
        ans_vocab_size: int,
        dropout_rate: float,
    ...
    # fmt: on
    def get_name(self):
        return 'VGG19_Transformer_cross_modal_attention_multijoint_learning'
    def get_params(self):
        return (
