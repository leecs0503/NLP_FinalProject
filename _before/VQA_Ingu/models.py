...
class VQAModel(nn.modules):
    def __init__(self,embed_size,question_vocabulary_size,answer_vocabulary_size,word_embed_size,num_layer,hidden_layer_size):
        super(self,VQAModel).__init__()
        self.image_encoder=ImageModel(embed_size)
        self.question_encoder=QuestionModel(question_vocabulary_size,word_embed_size,embed_size,num_layer,hidden_layer_size)
